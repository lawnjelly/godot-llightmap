...
* Version 0.39 (September 14th, 2020)
...
* It is highly recommended to bake final lightmaps at a size of 1024x1024 or more. Although baking is slower at larger sizes, it will reduce artifacts, and the lightmap textures can be downsized in a photo editing program if desired to save download space. Most levels _will_ show artifacts at 512x512 or less, and these sizes are intended for 'roughing out' a level.
